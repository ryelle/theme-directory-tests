...
function _manually_load_plugin() {
	require_once WP_CONTENT_DIR . '/plugins/theme-check/theme-check.php';
	require_once WP_CONTENT_DIR . '/plugins/theme-check/checkbase.php';
	require_once WP_CONTENT_DIR . '/plugins/theme-check/main.php';
	// @todo Do we need to load the theme itself?
}
